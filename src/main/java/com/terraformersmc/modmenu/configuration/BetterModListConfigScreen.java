...
public class BetterModListConfigScreen extends ConfigurationScreen.ConfigurationSectionScreen {
    ...
    public BetterModListConfigScreen(Screen parent, ModConfig.Type type, ModConfig modConfig, Component title) {
        super(parent, type, modConfig, title);
    }

    public BetterModListConfigScreen(Context parentContext, Screen parent, Map<String, Object> valueSpecs, String key, Set<? extends UnmodifiableConfig.Entry> entrySet, Component title) {
    ...
    protected <T> Element createList(String key, ModConfigSpec.ListValueSpec spec, ModConfigSpec.ConfigValue<List<T>> list) {
        if (key.equals("mod_badges") || key.equals("mod_parents")) return null;
