...
public class ModMenuConfig {
    ...
    public static final ModConfigSpec.EnumValue<Sorting> SORTING;
    public static final ModConfigSpec.BooleanValue COUNT_LIBRARIES;
    public static final ModConfigSpec.BooleanValue COMPACT_LIST;
    public static final ModConfigSpec.BooleanValue COUNT_CHILDREN;
    public static final ModConfigSpec.EnumValue<TitleMenuButtonStyle> MODS_BUTTON_STYLE;
    public static final ModConfigSpec.BooleanValue COUNT_HIDDEN_MODS;
    public static final ModConfigSpec.EnumValue<GameMenuButtonStyle> GAME_MENU_BUTTON_STYLE;
    public static final ModConfigSpec.EnumValue<ModCountLocation> MOD_COUNT_LOCATION;
...
//    public static final ModConfigSpec.BooleanValue UPDATE_CHANNEL;
  ...
  //  public static final ModConfigSpec.BooleanValue DISABLE_UPDATE_CHECKER;
   ...
   public static boolean quick_configure = true;
   ...
   public static HashSet<String> hidden_configs = new HashSet<>();
    ...
    static void onLoad(final ModConfigEvent.Loading event) {
        ...
        quick_configure = QUICK_CONFIGURE.get();
